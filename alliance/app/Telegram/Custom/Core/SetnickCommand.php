...
class SetnickCommand extends BaseCommand
{
    ...
    {
        if(!$this->isChannelAllowed()) return "You can only use this command in the channel linked to webby. Contact the webby admin.";
        ...
        if($user->tg_username) return "That web user has already been linked to a TG user ya daft cunt!.";
