...
class JmacCommand extends BaseCommand
{
    protected $command = "!jmac";
    ...
    public function execute()
    {
        ...
        if (!$param) return "Usage: !jmac <scan_grp_id>";
                ...
                if($planetId) {
                    ...
                    if($scanType == 'JUMPGATE PROBE') {
                        ...
                        for($int = 0; $int < $count; $int++) {
                            ...
                            if ($AllianceIDFrom) {
                                $AllianceNameFrom = ($ally_map_id_to_name[$AllianceIDFrom]) ?? "Unknown";
                            } else {
        ...
        $reply[] = "All INC SUMMARY - Especially useful for counting 2 and 3 fleeters! (Mac_)";
