...
// <?php echo e('@'.'include'); ?>		https://*.planetarion.com/*
// <?php echo e('@'.'include'); ?>		http://*.planetarion.com/*
// <?php echo e('@'.'include'); ?>		https://*.planetarion.com/*.p*
// <?php echo e('@'.'include'); ?>		http://*.planetarion.com/*.p*
// <?php echo e('@'.'include'); ?>		https://pa.ranultech.co.uk/*.p*
...
(function(w) {
	...
	s.setAttribute('src', '<?php echo e(url('/')); ?>/pascript');
	inject();
	function inject() {
...
<?php echo $__env->make('layouts.blank', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/patools/domains/webby.domain.tld/alliance/resources/views/userscript.blade.php ENDPATH**/ ?>